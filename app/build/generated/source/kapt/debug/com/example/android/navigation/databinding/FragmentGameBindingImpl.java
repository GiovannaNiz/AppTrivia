...
public class FragmentGameBindingImpl extends FragmentGameBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.game == variableId) {
            setGame((com.example.android.navigation.GameFragment) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setGame(@Nullable com.example.android.navigation.GameFragment Game) {
        this.mGame = Game;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        com.example.android.navigation.GameFragment.Question gameCurrentQuestion = null;
        ...
        com.example.android.navigation.GameFragment game = mGame;
